...
<div class="wrapper-page">
    <div class="panel panel-color panel-primary panel-pages login_b1">
        ...
        <form class="form-horizontal m-t-20"  action="{{ route('admin.reset.password.post') }}" method="post" target="_blank">
            @csrf
            <div class="form-group">
            		<h1 class="text-center">Reset your password?</h1>
                	<label class="text-center"> Enter your Email and password to reset your password! </label>
            </div>
            ...
            <div class="form-group text-center m-t-40 lc_color">
                   <a href="manage_users.html"> <button class="btn btn-primary btn-lg w-lg waves-effect waves-light rm01" type="submit">Submit</button></a>
            </div>
        </form>
