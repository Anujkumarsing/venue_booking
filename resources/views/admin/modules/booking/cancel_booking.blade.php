...
@section('title', 'Admin | Cancelled Bookings')
@section('links')
    ...
    <div class="content-page">
        <div class="content">
          ...
          <!-- Page-Title -->
            <div class="row">
                <div class="col-sm-12">
                  <h4 class="pull-left page-title">Cancelled Bookings</h4>
          ...
          <div class="row">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading rm02 rm04 rm_new01">
                        <form role="form" action="{{ route('cancelled.booking') }}" method="post">
                            @csrf
                            ...
                            <div class="rm05">
                                ...
                                <a href="{{ route('cancelled.booking') }}" class="btn btn-secondary waves-effect waves-light w-md">Reset</a>
                            </div>
                        </form>
                    </div>
                </div>
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td class="tablee_acttionn">
                                    <a href="{{ route('cancelled.view.booking', $booking->id) }}" class="css-tooltip-top color-blue">
