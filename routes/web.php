...
Route::prefix('admin')->middleware('admin.guard')->group(function () {
    Route::get('/dashboard', [DashboardController::class, 'index'])->name('admin.dashboard');
     ...
     Route::get('/calendar/reset', function () {
        session()->forget('selected_calendar_id');
        return redirect()->route('calendar_view');
    })->name('calendar.reset');
    Route::get('admin/view-booking/{id}', [CalenderController::class, 'viewBooking'])->name('calendar.view.booking');
...
Route::prefix('user')->middleware('user.auth')->group(function () {
    Route::any('/dashboard', [UserBookingController::class, 'index'])->name('user.dashboard');
    Route::any('/save-booking/{id?}', [UserBookingController::class, 'saveBooking'])->name('user.save.booking');
    Route::get('/booking/{id}/view', [UserBookingController::class, 'show'])->name('user.booking.view');
    Route::any('/calendar', [UserBookingController::class, 'userCalendarView'])->name('user.calendar.view');
    Route::any('/calendar/booking', [UserBookingController::class, 'fetchUserBookings'])->name('user.calendar.fetchBookings');
    Route::get('/calendar/view-booking/{id}', [UserBookingController::class, 'calendar_viewBooking'])->name('user.calendar.view.booking');
});
